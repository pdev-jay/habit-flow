    ...
    <View className="flex-row gap-2 rounded-lg bg-gray-200 p-1 dark:bg-gray-800">
      <Pressable
        className={cn(
          ...
          value === 'weekly' && (isDark ? 'bg-gray-700' : 'bg-white')
        )}
        ...
        <ThemedText
          className={cn(
            'text-sm font-medium',
            value === 'weekly' ? 'text-blue-500 dark:text-blue-400' : 'text-gray-500 dark:text-gray-400'
          )}>
      ...
      <Pressable
        className={cn(
          'h-8 flex-1 items-center justify-center rounded-md',
          value === 'monthly' && (isDark ? 'bg-gray-700' : 'bg-white')
        )}
        ...
        <ThemedText
          className={cn(
            'text-sm font-medium',
            value === 'monthly' ? 'text-blue-500 dark:text-blue-400' : 'text-gray-500 dark:text-gray-400'
          )}>
